package org.vinaylogics.windows.sessionwindow;
...
public class AverageProfit {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DataStream<Tuple5<String, String, String, Integer, Integer>> reduced = mapped
                .keyBy(f-> f.f0)
                .window(ProcessingTimeSessionWindows.withGap(Duration.of(1, ChronoUnit.SECONDS)))
                .reduce(new Reducer1());
...
//        reduced.writeAsText("/home/vinay/www");
