package org.vinaylogics.watermark.periodicwatermarks;
...
public class WindowType {
        ...
        DataStream<Tuple2<Long, String>> sum = data.map((MapFunction<String, Tuple2<Long, String>>) s -> {
            ...
            return new Tuple2<>(Long.parseLong(words[0]), words[1]);
              ...
              .assignTimestampsAndWatermarks(new DemoWatermark())
                .windowAll(EventTimeSessionWindows.withGap(Duration.of(1, ChronoUnit.SECONDS)))
    ...
    public static final class DemoWatermark implements AssignerWithPeriodicWatermarks<Tuple2<Long, String>> {
        ...
        public Watermark getCurrentWatermark() {
            // return the watermark as the current highest timestamp minus the out-of-orderness bound
            return new Watermark(currentTimestamp-allowedlatetime);
        }
